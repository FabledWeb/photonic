...
/*	array("name" => "Carousel mode",
	...
	array("name" => "Link Tracking - Google Analytics UTM Source",
		"desc" => "utm_source to use for your Google Analytics campaign tracking",
		"id" => "utm_source",
		"grouping" => "generic-settings",
		"type" => "text",
		"std" => "",
	),
	array("name" => "Link Tracking - Google Analytics UTM Medium",
		"desc" => "utm_medium to use for your Google Analytics campaign tracking",
		"id" => "utm_medium",
		"grouping" => "generic-settings",
		"type" => "text",
		"std" => "",
	),
	array("name" => "Link Tracking - Google Analytics UTM Campaign",
		"desc" => "utm_campaign to use for your Google Analytics campaign tracking",
		"id" => "utm_campaign",
		"grouping" => "generic-settings",
		"type" => "text",
		"std" => "",
